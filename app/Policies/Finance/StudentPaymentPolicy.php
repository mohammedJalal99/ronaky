...
class StudentPaymentPolicy
{
    ...
    {
        return $user->can('view_any_finance::student::payment');
    }
    ...
    {
        return $user->can('view_finance::student::payment');
    }
    ...
    {
        return $user->can('create_finance::student::payment');
    }
    ...
    {
        return $user->can('update_finance::student::payment');
    }
    ...
    {
        return $user->can('delete_finance::student::payment');
    }
    ...
    {
        return $user->can('delete_any_finance::student::payment');
    }
