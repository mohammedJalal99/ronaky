...
class FatherPolicy
{
    ...
    {
        return $user->can('view_any_student::father');
    }
    ...
    {
        return $user->can('view_student::father');
    }
    ...
    {
        return $user->can('create_student::father');
    }
    ...
    {
        return $user->can('update_student::father');
    }
    ...
    {
        return $user->can('delete_student::father');
    }
    ...
    {
        return $user->can('delete_any_student::father');
    }
