...
use App\Filament\Resources\Student\MotherResource\Pages;
use App\Filament\Resources\Student\MotherResource\RelationManagers;
...
class MotherResource extends Resource
{
    ...
    protected static ?string $label = "دایک";
    protected static ?string $pluralLabel = "دایکان";
    protected static ?string $navigationGroup = 'پەپولەکان';

    protected static ?string $navigationIcon = 'mdi-mother-nurse';
