    ...
    public static function getResourceEntitiesSchema(): ?array
    {
        return collect(FilamentShield::getResources())
            ...
            ->map(function ($entity) {
                ...
                $recourse  = new $entity['fqcn']();

                return Forms\Components\Section::make($sectionLabel)
                    ->icon($recourse::getNavigationIcon())
                    ->iconColor('primary')
                    ->iconSize('lg')
                    ->description(fn () => new HtmlString('<span style="word-break: break-word;">' . $recourse::getNavigationGroup(). '</span>'))
                    ->compact()
                    ->schema([
